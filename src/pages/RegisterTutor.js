  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100 py-10">
      <div className="w-full max-w-lg bg-white p-8 rounded-lg shadow-lg">
        <h2 className="text-3xl font-semibold text-center text-blue-600 mb-6">Register as Tutor</h2>
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          {/* Course Specialty Field */}
          <div className="mb-5">
            <label className="block text-gray-700 font-medium">Course Specialty</label>
            <input
              type="text"
